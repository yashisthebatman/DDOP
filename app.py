...
import config
from environment import Environment, Order, Building, WeatherSystem
...
def load_planner():
    ...
    log_event("Loading planner and pre-computed heuristics...")
    ...
    if planner.heuristic_lookup_table is None:
        st.error("FATAL: 'quantum_heuristic.pkl' not found. Please run `generate_heuristic.py` first!", icon="🚨")
        return None
