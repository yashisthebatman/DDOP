# ... (imports and dataclasses unchanged) ...
import numpy as np
...
class Environment:
    # ... (__init__, _add_obstacle_to_index, _generate_and_index_buildings unchanged) ...
    ...
    def _index_static_nfzs(self):
        ...
        for zone in self.static_nfzs:
            # FIX: The bottom of the NFZ should be MIN_ALTITUDE, not 0.
            bounds = (zone[0], zone[1], MIN_ALTITUDE, zone[2], zone[3], MAX_ALTITUDE)
            self._add_obstacle_to_index(bounds)

    # ... (rest of Environment class is unchanged and correct) ...
